...
/**
 * Ids built so their natural ordering is predictable: [author] `n` sorts ascending in `n`,
 * which matters because the fair-share remainder is handed out in ascending author order.
 */
